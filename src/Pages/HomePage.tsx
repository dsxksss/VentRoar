      ...
      <div className="h-[94vh] flex flex-col items-center transform duration-200 ease-in-out shadow-lg dark:bg-[#253446]">
        ...
        <div className="flex justify-center items-center space-x-3 h-[30vh] w-[90vw] ">
          ...
          <div className="flex font-bold flex-col space-y-5 justify-center">
            <div className="flex indent-4 flex-col justify-center items-center h-[10vh] overflow-hidden duration-200 ease-in-out  bg-slate-50 dark:bg-[#304053] text-left rounded-2xl px-3 shadow-md py-4 text-green-500">
              <span>不能因为一点小挫折就垂头丧气</span>
            </div>
            <div className="flex flex-col justify-center items-center h-[15vh] overflow-hidden duration-200 ease-in-out  bg-slate-50 dark:bg-[#304053] rounded-2xl shadow-md px-3 py-4 text-center text-gray-900 dark:text-gray-300">
        ...
        <div className="flex justify-center items-center space-x-3 h-[30vh] w-[90vw] ">
          <div className="flex font-bold flex-col space-y-5 justify-center">
            <div className="flex flex-col justify-center items-center  h-[10vh] overflow-hidden duration-200 ease-in-out  bg-slate-50 dark:bg-[#304053] text-left rounded-2xl px-3 shadow-md py-4 text-green-500">
              <span>用户信息全加密</span>
            </div>
            <div className="flex flex-col justify-center items-center h-[15vh] overflow-hidden duration-200 ease-in-out  bg-slate-50 dark:bg-[#304053] rounded-2xl shadow-md px-3 py-4 text-center text-gray-900 dark:text-gray-300">
              <span>以匿名的方式公布...</span>
